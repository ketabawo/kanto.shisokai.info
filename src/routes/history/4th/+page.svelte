<script lang="ts">
  ...
  const event = events.find(e => e.id === '4th')!;
  const members = getMembersForEvent('4');
...
<svelte:head>
  ...
  <link rel="canonical" href="https://kanto.shisokai.info/history/4th/">
  <meta property="og:type" content="website">
  <meta property="og:url" content="https://kanto.shisokai.info/history/4th/">
