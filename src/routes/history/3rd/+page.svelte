<script lang="ts">
  ...
  const event = events.find(e => e.id === '3rd')!;
  const members = getMembersForEvent('3');
...
<svelte:head>
  ...
  <link rel="canonical" href="https://kanto.shisokai.info/history/3rd/">
  <meta property="og:type" content="website">
  <meta property="og:url" content="https://kanto.shisokai.info/history/3rd/">
