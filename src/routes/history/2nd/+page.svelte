<script lang="ts">
  ...
  const event = events.find(e => e.id === '2nd')!;
  const members = getMembersForEvent('2');
...
<svelte:head>
  ...
  <link rel="canonical" href="https://kanto.shisokai.info/history/2nd/">
  <meta property="og:type" content="website">
  <meta property="og:url" content="https://kanto.shisokai.info/history/2nd/">
